...
catalogue = [
    {"id": 1, "name": "Bags", "category":1, "price": 1299},
    {"id": 2, "name": "Perfumes", "category":2, "price": 1620},
    {"id": 3, "name": "Jackets", "category":3, "price": 2750},
    {"id": 4, "name": "Dresses", "category":4, "price": 6820},
]

 #Function to display the catalogue
def display_catalogue():
    print("Product Id\tName\t\tCategory\tPrice")
    for product in catalogue:# Call the display_catalogue function to show the catalogue
...
def add_to_cart(session_id, product_id, quantity):
    ...
    print(f"{quantity} pieces of {product['name']} added to the cart.") # Function to delete an item from the cart
